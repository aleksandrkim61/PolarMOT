...
CENTER_POINT_MINI = 'centerpoint_mini'
CENTER_POINT_SINGAPORE = 'centerpoint_singapore'
CENTER_POINT_BOSTON = 'centerpoint_boston'
...
POINTGNN_DETS_DIR = MOUNT_PATH + "/storage/slurm/kimal/eagermot_input/pointgnn/" + SPLIT
DETECTIONS_AB3DMOT = MOUNT_PATH + "/storage/slurm/kimal/eagermot_input/ab3dmot/" + SPLIT
DETECTIONS_EFFICIENT_DET_NUSCENES = MOUNT_PATH + "/storage/slurm/kimal/eagermot_input/efficientdet/" + SPLIT
DETECTIONS_INPUT_FOLDER = MOUNT_PATH + "/storage/slurm/kimal/eagermot_input/"

SEGMENTATIONS_TRACKRCNN_DIR = MOUNT_PATH + "/storage/slurm/kimal/eagermot_input/trackrcnn/" + SPLIT
MOTSFUSION_RRC_DIR = MOUNT_PATH + "/storage/slurm/kimal/eagermot_input/detections_segmentations_RRC_BB2SegNet/" + SPLIT
MOTSFUSION_TRACKRCNN_DIR = MOUNT_PATH + "/storage/slurm/kimal/eagermot_input/detections_segmentations_trackrcnn_BB2SegNet/" + SPLIT
DETECTIONS_MMDETECTION_CASCADE_NUIMAGES_NUSCENES = MOUNT_PATH + \
    "/storage/slurm/kimal/eagermot_input/mmdetection_cascade_x101/" + SPLIT
DETECTIONS_MMDETECTION_CASCADE_NUIMAGES_KITTI = MOUNT_PATH + \
    "/storage/slurm/kimal/eagermot_input/mmdetection_cascade_x101_kitti/" + SPLIT
...
DETECTIONS_3DOP_PATH = MOUNT_PATH + "/storage/slurm/kimal/eagermot_input/3dop/" + SPLIT
