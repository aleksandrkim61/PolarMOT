...
def load_detections_centerpoint(folder_name: str) -> Dict[str, List[Bbox3d]]:
    filepath = os.path.join(utils.DETECTIONS_INPUT_FOLDER, folder_name, SPLIT, "detections.json")
...
def load_annotations_kitti(seq_name: str) -> Dict[str, List[Bbox3d]]:
    ...
    for line in content:
        ...
        bbox_3d = Bbox3d(np.array([*center_xyz, rotation_around_y, *dims_lwh]),
                         gt_track_id=track_id, confidence=1.0, obs_angle=occlusion, seg_class_id=class_id,
